...
<body>
    ...
    <div>
        ...
        <div class="home_main fit">
            ...
            <img id="fade_img" class="fit" src="./tools/fade_bw.png" alt="">
    ...
    <div class="register_main blue_bar">
        <div class="register_bg blue_bar">
        </div>
    </div>
    ...
    <!--ADD CAPTIONS FOR THE IMAGES! OR ELSE REMOVE THEM  'H3' AND 'P' TAGS-->
    <!--carousel-->
    ...
    <div id="a_about" class="about_main fit">
        <div class="about_bg">
            ...
            <div class="about_text">
                <h1>About</h1>
                <p>TYPE SOMETHING ABOUT THE Restauranté 
                    like we ae finest restaurant in dwarka!!! :)
                    Contact details and address maybe
                </p>
            </div>
    ...
    <div id="footer_home">
        <div id="bg_left" style="width: 15%;height: 300px;background-image: url(&quot;Footer/assets/img/footer-bkg-img1.png&quot;);background-size: contain;background-repeat: no-repeat;background-position: left;margin-top: 20px;"></div>
