                            ...
                            <div class="otw-widget-form-wrap">
                                ...
                                {   
                                    if(isset($_GET['booking']))
                                    {
                                        ...
                                        {
                                            echo '<h3 style=" color:snow; font-family: Ubuntu, sans-serif; font-size: 1.3rem;">THANKS! YOUR REQUEST IS SAVED.<br><div style="margin: auto; width: fit-content;"><img style=" height: 100px;"src="..\img\happy-clipart-10.png"></div><br>
                                            YOU\'LL RECIEVE A MAIL SHORTLY..<br><br></h3>';
                                            echo '<h3 style="color:yellow; font-family: Ubuntu, sans-serif; font-size: 1.3rem;">WANT TO MAKE MORE BOOKINGS? </h3>';
                                            echo '<div style="  color: white !important;padding: 11px; border-radius: 10px; overflow: hidden; background-color: teal;"><a style="  color: white !important;" href="index.php">BOOK TABLE</a></div>';
                                        }
                                    }
                                    else{
                                        echo' <form action="booktable.php" method="post" class="otw-widget-form">
                                            <div class="otw-wrapper">
                                                <div class="otw-name-wrap otw-input-wrap">
                                                    <input name="Name" class="otw-reservation-name" type="text" value="'.$_SESSION["userUid"].'" readonly>                                                </div>
                                                <div class="otw-email-wrap otw-input-wrap">
                                                    <input name="mail" class="otw-reservation-email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" type="text" placeholder="Your email" required>
                                                </div>
                                                <div class="otw-date-wrap otw-input-wrap">
                                                    <input name="startDate" class="otw-reservation-date" type="text" value="'.date("d/m/Y").'" autocomplete="off" pattern="[0-3]{1}[0-9]{1}/[0-1]{1}[0-9]{1}/[0-9]{4}" data-date-format="mm/dd/yyyy">
                                                </div>
                                    ...
                                    echo '<h4 id="nologin">YOU MIGHT BE NOT LOGGED IN!<BR><br>PLEASE LOGIN FIRST</h4>';
